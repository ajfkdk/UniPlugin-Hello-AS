package cn.hzw.doodle.view.seekbar.config;
...
import cn.hzw.doodle.view.seekbar.IndicatorSeekBar;
...
public class Builder {
    ...
    public int showTickMarksType = TickMarkType.NONE;
    public int tickMarksColor = Color.parseColor("#FF4081");
    public int tickMarksSize = 0;
    ...
    public IndicatorSeekBar build() {
        return new IndicatorSeekBar(context);
    }
